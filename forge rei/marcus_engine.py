...
# Ambiguous recipient phrases are denials only when the complete message consists of
# mistaken-identity clauses. This keeps seller continuations from being discarded.
_DENIAL_CLAUSE = (
    r"(?:"
