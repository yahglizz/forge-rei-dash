      ...
      <div style={{ display: "flex", alignItems: "center", gap: 12, flexWrap: "wrap" }}>
        <div style={{ flex: 1, minWidth: 200 }}>
          <div className="card-title" style={{ fontSize: 15 }}>
            ...
            {s.degradedPrompt && <span title="One or more required Marcus skills are empty"
              style={{ marginLeft: 8, padding: "2px 5px", borderRadius: 4, fontSize: 10,
                fontWeight: 800, color: "#FCA5A5", background: "rgba(239, 68, 68, 0.12)",
                border: "1px solid rgba(239, 68, 68, 0.35)", letterSpacing: 0 }}>
              DEGRADED PROMPT
            </span>}
          </div>
